...
class UnionFind:
    ...
    def add_member(self, member: int):
        """
        Add a member to the UF
        Args:
            member: id of the member to add
    ...
    def find(self, member: int):
        """
        Find the parent of a member in the UF
        Args:
            member: id of the member to find the parent for
    ...
    def path_compress(self, member, parent):
        ...
        Args:
            member: id for the member to connect to a parent
            parent: id for parent member following path compression
    ...
    def union(self, member_1: int, member_2: int):
        ...
        Args:
            member_1: unique id for member 1
            member_2: uniqeu id for member 2
